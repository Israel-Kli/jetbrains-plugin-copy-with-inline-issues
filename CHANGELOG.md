...
- **Deprecated API migration** - Replaced deprecated `runReadAction(Function0)` with `ReadAction.compute()` in `ProblemDetectionService.runInspectionsOnRange()` to resolve compatibility warning with IntelliJ Platform 261+
...
[Unreleased]: https://github.com/Israel-Kli/jetbrains-plugin-copy-with-inline-issues/compare/v1.1.1...HEAD
